...
Live Pages verification succeeded over HTTPS with no page errors: 14 startup resource requests totaling 1,902,374 decoded bytes in the recorded Chromium run. Neither locked wing was requested. This is resource-size evidence from one run, not a universal network-speed or frame-rate guarantee. Desktop card art and the 390px duel controls were inspected.
