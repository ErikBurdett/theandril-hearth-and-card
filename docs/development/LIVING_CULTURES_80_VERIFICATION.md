...
Status: **Local acceptance complete; source release published**. This record covers the 224-card expansion beyond the initial four 24-card folios. Content, runtime paintings and visual approvals are pinned at [`53f7501`](https://github.com/ErikBurdett/theandril-hearth-and-card/commit/53f750128d742a6edcf462fbf7441b81a9925e95). The [initial release record](LIVING_CULTURES_VERIFICATION.md) remains a separate historical checkpoint. The maintained acceptance status is the `living-cultures-full-sets` item in [the roadmap](../ROADMAP.md). This document records local acceptance and archive publication; GitHub's [Checks](https://github.com/ErikBurdett/theandril-hearth-and-card/actions/workflows/ci.yml) and [Publish game](https://github.com/ErikBurdett/theandril-hearth-and-card/actions/workflows/pages.yml) runs report deployment status for each exact commit.
...
The published [source release](https://github.com/ErikBurdett/theandril-hearth-and-card/releases/tag/art-living-cultures-80-v1) supplies `art-living-cultures-80-v1.tar.gz`: **742,224,990 bytes / 1,140 files**, SHA-256 `04104cf99a3c24b10df297284cd39b6e07727af7919ce54e50612bc32cd5e280`. Every archived member was read back and hashed against its retained original. GitHub's uploaded asset metadata independently reports that exact byte count and SHA-256 digest. It contains 224 source PNGs, 224 generation records, 224 candidate PNGs, 224 review PNGs, 224 original runtime PNGs and twenty contact sheets. Existing archives remain unchanged. The checksum-pinned manifest provides the permanent restore URL; the release was published on September 14, 2026 UTC against the content commit above.
